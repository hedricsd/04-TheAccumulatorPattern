...
#                  count = 0                should be before the for statement
#                  if math.cos(r) > 0:      r should be r + k
#                      count = 1            needs to add previous count ex: count = count + 1
#                  return count             needs to be outside of loop
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?     A loop variable is not used in a loop
#
